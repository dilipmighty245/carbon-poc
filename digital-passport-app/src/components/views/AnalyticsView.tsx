...
export const AnalyticsView: React.FC = () => {
  ...
  const kpis = [
    { title: 'CCF Reduction', val: '8.4%', subtitle: 'Against FY2024 baseline', color: 'text-emerald-600' },
    { title: 'Verified Portfolio', val: '64%', subtitle: 'By product revenue', color: 'text-emerald-600' },
    { title: 'Energy Savings', val: '11.2%', subtitle: '12-month rolling', color: 'text-emerald-600' },
    { title: 'Avoided Cost', val: '€318k', subtitle: 'Approved initiatives', color: 'text-emerald-600' },
  ];
  ...
  const records = [
    { name: 'Industrial Processing', emissions: '6,840 tCO₂e', trend: '-9.1%', completion: '92% complete' },
    { name: 'Materials & Supply', emissions: '3,486 tCO₂e', trend: '-4.7%', completion: '84% complete' },
    { name: 'Logistics', emissions: '1,428 tCO₂e', trend: '-11.3%', completion: '89% complete' },
    { name: 'Corporate Operations', emissions: '1,088 tCO₂e', trend: '-7.8%', completion: '97% complete' },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-2 text-xs font-semibold text-slate-500">
          ...
          <span>/</span>
          <span className="text-slate-900 font-bold">Executive Carbon Analytics</span>
        </div>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">Executive Carbon Analytics</h1>
          <p className="text-xs text-slate-500 font-medium">Enterprise carbon, energy, product, supplier and trade performance</p>
        </div>
      ...
      {/* Middle Row (2/3 Chart + 1/3 Portfolio health) */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left 2/3: Emissions, production and intensity trend */}
        <div className="lg:col-span-2 bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between">
          <h3 className="font-bold text-slate-900 text-sm mb-4">Emissions, production and intensity trend</h3>
        ...
        <div className="divide-y divide-slate-100 text-xs">
          {records.map((r, i) => (
            <div key={i} className="py-3 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <div className="w-36 text-slate-700 font-bold">
