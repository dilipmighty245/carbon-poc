...
import { Check, RefreshCw, Download, Search, FileText } from 'lucide-react';
...
export const PCFView: React.FC = () => {
  ...
  const kpis = [
    { title: 'Total Footprint', val: '284.0 tCO₂e', subtitle: 'Batch CB-2026-001', color: 'text-slate-400' },
    { title: 'PCF Intensity', val: '2.84 kgCO₂e/kg', subtitle: 'Cradle-to-gate', color: 'text-emerald-600' },
    { title: 'Data Quality', val: '92 / 100', subtitle: 'High confidence', color: 'text-emerald-600' },
    { title: 'Verification', val: 'Ready', subtitle: 'All calculations locked', color: 'text-slate-400' },
  ];
  ...
  const records = [
    { name: 'Cocoa beans', qty: '82,000 kg', provenance: 'Supplier PCF v2', emissions: '147.6 tCO₂e' },
    { name: 'Grid electricity', qty: '214 MWh', provenance: 'Ghana grid 2026', emissions: '82.4 tCO₂e' },
    { name: 'Natural gas', qty: '18,400 Nm³', provenance: 'DEFRA 2026', emissions: '37.2 tCO₂e' },
    { name: 'Packaging & logistics', qty: '100,000 units', provenance: 'Mixed methods', emissions: '16.8 tCO₂e' },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 font-medium">
            Batch-level lifecycle footprint for Refined Cocoa Butter · <span className="font-mono text-slate-700">CB-2026-001</span>
          </p>
        </div>
      ...
      {/* Middle Row (2/3 Contribution Chart + 1/3 Readiness Gates) */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left 2/3: Lifecycle stage contribution */}
        <div className="lg:col-span-2 bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between">
          <h3 className="font-bold text-slate-900 text-sm mb-4">Lifecycle stage contribution</h3>
