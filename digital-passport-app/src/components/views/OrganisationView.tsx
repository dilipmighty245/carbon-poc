...
export const OrganisationView: React.FC = () => {
  ...
  const kpis = [
    { title: 'Active Facilities', val: '4', subtitle: '3 production · 1 warehouse', color: 'text-slate-400' },
    { title: 'Connected Devices', val: '38', subtitle: '35 online', color: 'text-emerald-600' },
    { title: 'Reporting Coverage', val: '96%', subtitle: 'Across active sites', color: 'text-slate-400' },
    { title: 'Open Tasks', val: '7', subtitle: '2 high priority', color: 'text-slate-400' },
  ];
  ...
  const records = [
    { name: 'Tema Processing Plant', location: 'Ghana', status: 'ACTIVE', statusClass: 'bg-emerald-50 text-emerald-700 border-emerald-100', coverage: '96%' },
    { name: 'Kumasi Materials Hub', location: 'Ghana', status: 'ACTIVE', statusClass: 'bg-emerald-50 text-emerald-700 border-emerald-100', coverage: '91%' },
    { name: 'Takoradi Export Warehouse', location: 'Ghana', status: 'ACTIVE', statusClass: 'bg-emerald-50 text-emerald-700 border-emerald-100', coverage: '98%' },
    { name: 'Accra Corporate Office', location: 'Ghana', status: 'ACTIVE', statusClass: 'bg-emerald-50 text-emerald-700 border-emerald-100', coverage: '88%' },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-2 text-xs font-semibold text-slate-500">
          ...
          <span>/</span>
          <span className="text-slate-900 font-bold">Organisation & Facilities</span>
        </div>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 tracking-tight">Organisation & Facilities</h1>
          <p className="text-xs text-slate-500 font-medium">Manage company identity, operating sites, roles and reporting periods</p>
        </div>
      ...
      {/* Middle Row (2/3 Chart + 1/3 Facility readiness) */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left 2/3: Facility emissions and production */}
        <div className="lg:col-span-2 bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between">
          <h3 className="font-bold text-slate-900 text-sm mb-4">Facility emissions and production</h3>
